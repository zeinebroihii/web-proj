                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <?php
                                ...
                                {
                                    $ticket = $ticketc->showTicket($_GET['IDTicket']); 
                            ?>
                            <form  method="get">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="FirstName" name="FirstName" aria-describedby="emailHelp" value="<?php echo $ticket['FirstName']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">LastName</label>
                                    <input type="text" class="form-control" id="LastName" name="LastName" value="<?php echo $ticket['LastName']; ?>">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="Event" name="Event" value="<?php echo $ticket['Event']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Pickup Date</label>
                                    <input type="date" class="form-control" id="PickupDate" name="PickupDate" value="<?php echo $ticket['PickupDate']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Pickup Time</label>
                                    <input type="time" class="form-control" id="PickupTime" name="PickupTime" value="<?php echo $ticket['PickupTime']; ?>">
                                </div>
